...
//using OnlineCourse.Core.Utils;
//using OnlineCourse.Core.WorkFlows;
//using OnlineCourse.Entity.Models;
//using OnlineCourse.Panel.Core;
//using OnlineCourse.Panel.utilities;
//using OnlineCourse.Panel.utilities.HtmlHelpers;
//using OnlineCourse.Panel.utilities.ViewModels.Areas.Admin;
//using System.Collections.Generic;
//using OnlineCourse.Panel.utilities.ViewModels.AccountViewModels;
//using Microsoft.AspNetCore.Mvc.Localization;
//using OnlineCourse.Panel.Models;
//using OnlineCourse.Core.Dtos;
//using OnlineCourse.Entity;
//using OnlineCourse.Panel.Extentions;
...
//        private readonly AuthMessageSender _msgSender;
...
//        public UsersController(IUnitOfWork unitOfWork, IServiceProvider provider, HistoryService historyService, IHostingEnvironment hostingEnvironment, IMapper mapper, CUser cUser, IHtmlLocalizer<SharedResource> localizer, PublicConfig config)
//        {
//            _unitOfWork = unitOfWork;
//            _provider = provider;
//            _historyService = historyService;
//            _msgSender = new AuthMessageSender();
...
//                _historyService.LogError(e, CHistoryErrorType.Middle);
//                return View();
//            }
...
//                                    Encryption.GetUrlHash(gal.Id.ToString() + gal.PublicId + gal.Kind), user.Image);
...
//                                if (count > 0)
//                                {
//                                    var filePath = new Uploder(_hostingEnvironment, _historyService).UploadGallery(Encryption.GetUrlHash(gal.Id.ToString() + gal.PublicId + gal.Kind), Image);
...
//                    if (dbUser != null)
//                    {
//                        var req = new UserChangePassword(_provider, _msgSender, _historyService).CahngePassword(new ChangePasswordDto() { UserName = dbUser.UserName, Password = model.OldPass, NewPassword = model.NewPass, ConfirmNewPassword = model.ConfirmNewPass, Ip = WebHelpers.GetRemoteIP });
